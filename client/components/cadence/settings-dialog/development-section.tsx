...
export function DevelopmentSection({
  ...
  return (
    <div className="flex flex-col gap-5">
      <div>
        <h3 className="text-[14px] font-semibold text-foreground">Development</h3>
      ...
      <div className="rounded-lg border border-border bg-card px-5 py-4">
        ...
        <div className="mt-3.5 flex gap-1 rounded-lg border border-border bg-secondary/30 p-1">
        ...
        {currentHint ? (
          <p className="mt-2.5 text-[12px] text-muted-foreground">{currentHint}</p>
        ) : null}
      </div>
      ...
      <div className="rounded-lg border border-border bg-card px-5 py-4">
        <div className="flex items-center gap-3.5">
          ...
          <Button size="sm" className="h-9 text-[12px]" disabled={!onStartOnboarding} onClick={onStartOnboarding}>
            Start onboarding
          </Button>
        </div>
      </div>
