                ...
                <div className="flex shrink-0 items-center gap-2">
                  {!hasRoutes && !formOpen ? (
                    <>
                      ...
                      <Button size="sm" className="h-7 text-[11px]" disabled={!canMutate} onClick={() => startNew(kind)}>
                ...
                <div className="mt-3 grid gap-0.5 border-t border-border pt-2">
                  {channelRoutes.map((route) => {
                    ...
                    return (
                      ...
                      >
                        <div className="min-w-0 flex-1">
                          <p className="text-[12px] leading-none font-medium text-foreground">{route.routeId}</p>
                  ...
                  <div className="grid gap-3">
                    <div className="grid grid-cols-2 gap-3">
                      <div className="space-y-1.5">
                        <Label htmlFor={`s-route-id-${kind}`} className="text-[11px]">
                          Route name
                        </Label>
                        <Input
                          id={`s-route-id-${kind}`}
                      ...
                      <div className="space-y-1.5">
                        <Label htmlFor={`s-route-target-${kind}`} className="text-[11px]">
                          Target
                        </Label>
                        <Input
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Button size="sm" variant="ghost" className="h-7 text-[11px]" onClick={cancelForm}>
                        Cancel
                      </Button>
                    </div>
                  </div>
