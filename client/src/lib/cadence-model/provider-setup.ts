...
const OPENAI_COMPATIBLE_SETUP_RECIPES: ProviderSetupRecipeDto[] = [
  {
    ...
    guidance: 'Use the LiteLLM proxy base URL configured for your local gateway.',
  ...
  },
  {
    ...
    guidance: 'Start the LM Studio local server before checking the local /v1 endpoint.',
    repairSuggestion: 'Start the LM Studio server, load a model, and check that the local /v1 endpoint answers requests.',
  },
  {
    recipeId: 'mistral',
    label: 'Mistral',
    ...
    guidance: 'Use the Mistral API base URL with a saved Mistral API key.',
    repairSuggestion: 'Verify the Mistral API key and base URL, then check the connection again.',
  },
  {
    recipeId: 'groq',
    label: 'Groq',
    ...
    guidance: 'Use a Groq API key with the Groq OpenAI-compatible endpoint.',
    repairSuggestion: 'Verify the Groq API key and endpoint URL, then check the connection again.',
  },
  {
    recipeId: 'together',
    label: 'Together AI',
    ...
    guidance: 'Use the Together /v1 endpoint with a saved Together API key.',
    repairSuggestion: 'Confirm the Together API key has inference access for your account.',
  },
  {
    recipeId: 'deepseek',
    label: 'DeepSeek',
    ...
    guidance: 'Use the DeepSeek /v1 endpoint with a saved DeepSeek API key.',
    repairSuggestion: 'Verify the DeepSeek API key and endpoint URL, then check the connection again.',
  },
  {
    recipeId: 'nvidia_nim',
    label: 'NVIDIA NIM',
    ...
    guidance: 'Use the NVIDIA API Catalog /v1 endpoint with a saved NVIDIA API key.',
    repairSuggestion: 'Confirm the NVIDIA API key is valid and the NIM endpoint can answer /models.',
  },
  {
    recipeId: 'minimax',
    label: 'MiniMax',
    ...
    guidance: 'Use the MiniMax OpenAI-compatible base URL with a saved MiniMax API key.',
    repairSuggestion: 'Verify the MiniMax API key and endpoint URL, then check the connection again.',
  },
  {
    ...
    guidance: 'Use the Azure AI Foundry OpenAI-compatible endpoint for your deployment route.',
    repairSuggestion: 'Confirm the Foundry endpoint route and API key. Use the Azure OpenAI preset instead for deployment URLs that require api-version metadata.',
  },
  {
    ...
    apiKeyPlaceholder: 'No API key',
    modelPlaceholder: 'local-model',
    guidance: 'Start Atomic Chat with its local server enabled before checking the local endpoint.',
  ...
  },
  {
    ...
    guidance: 'Use the gateway root ending in /v1 with the key that gateway expects.',
