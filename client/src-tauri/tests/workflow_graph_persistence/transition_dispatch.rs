use super::support::*;
pub(crate) fn workflow_transition_is_transactional_and_event_is_durable() {
...
pub(crate) fn workflow_transition_auto_dispatches_single_legal_next_edge() {
    let root = tempfile::tempdir().expect("temp dir");
...
pub(crate) fn workflow_transition_auto_dispatch_fails_closed_on_ambiguous_next_edge() {
    let root = tempfile::tempdir().expect("temp dir");
...
pub(crate) fn workflow_transition_auto_dispatch_skips_when_next_edge_has_unresolved_gates() {
    let root = tempfile::tempdir().expect("temp dir");
...
pub(crate) fn workflow_transition_auto_dispatch_replays_idempotently() {
    let root = tempfile::tempdir().expect("temp dir");
...
pub(crate) fn workflow_transition_auto_dispatch_replay_surfaces_missing_handoff_package_row() {
    let root = tempfile::tempdir().expect("temp dir");
...
pub(crate) fn workflow_transition_auto_dispatch_replay_surfaces_transition_linkage_mismatch() {
    let root = tempfile::tempdir().expect("temp dir");
...
pub(crate) fn workflow_transition_rejects_secret_bearing_diagnostics_and_preserves_state() {
    let root = tempfile::tempdir().expect("temp dir");
...
pub(crate) fn workflow_transition_rejects_malformed_target_gate_rows_and_preserves_state() {
    let root = tempfile::tempdir().expect("temp dir");
