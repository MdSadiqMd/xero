...
const MIGRATION_028_COMPUTER_USE_MODE_SQL: &str = r#"
    ...
    VALUES
        ('computer_use', 1, 'Computer Use', 'Computer', 'Follow direct user instructions using the tools available for the current turn.', 'built_in', 'active', 'computer_use', '2026-05-24T00:00:00Z');
