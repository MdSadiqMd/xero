...
pub(crate) const CADENCE_GLOBAL_DB_PATH_ENV: &str = "CADENCE_GLOBAL_DB_PATH";
pub(crate) const CADENCE_RUNTIME_MCP_CONFIG_PATH_ENV: &str = "CADENCE_RUNTIME_MCP_CONFIG_PATH";
pub(crate) const CADENCE_RUNTIME_MCP_CONTRACT_REQUIRED_ENV: &str =
    "CADENCE_RUNTIME_MCP_CONTRACT_REQUIRED";
