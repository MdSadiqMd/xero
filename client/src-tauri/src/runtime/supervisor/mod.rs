...
use crate::{
    ...
    db::project_store::{
        ...
        RuntimeRunDiagnosticRecord, RuntimeRunStatus,
    },
};
...
use super::protocol::{
    ...
    SupervisorProtocolDiagnostic, SupervisorSkillCacheStatus, SupervisorSkillDiagnostic,
...
fn emit_normalized_events(
    ...
    for event in events {
        ...
        {
            let _ = sidecar::persist_sidecar_checkpoint(
                repo_root,
                shared,
                persistence_lock,
...
fn emit_interactive_boundary_if_detected(
    ...
    match persisted {
        ...
        Err(error) => {
            ...
            let _ = sidecar::persist_sidecar_runtime_error(
                repo_root,
                shared,
                persistence_lock,
                &error.code,
