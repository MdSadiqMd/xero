...
fn effect_class_id(effect_class: AgentToolEffectClassDto) -> &'static str {
    match effect_class {
        ...
        AgentToolEffectClassDto::DesktopControl => "desktop_control",
...
fn effect_class_from_str(value: &str) -> Option<AgentToolEffectClassDto> {
    match value {
        ...
        "desktop_control" => Some(AgentToolEffectClassDto::DesktopControl),
...
fn effect_class_from_runtime(class: AutonomousToolEffectClass) -> AgentToolEffectClassDto {
    match class {
        ...
        AutonomousToolEffectClass::DesktopControl => AgentToolEffectClassDto::DesktopControl,
