...
pub fn runtime_agent_descriptor(agent_id: RuntimeAgentIdDto) -> RuntimeAgentDescriptorDto {
    match agent_id {
        ...
        RuntimeAgentIdDto::ComputerUse => RuntimeAgentDescriptorDto {
            ...
            description: "Follow direct user instructions using the tools available for the current turn.".into(),
            task_purpose: "Complete general-purpose computer, project, automation, and tool-assisted tasks while respecting approvals, secrets, and safety boundaries.".into(),
            scope: RuntimeAgentScopeDto::BuiltIn,
            lifecycle_state: RuntimeAgentLifecycleStateDto::Active,
