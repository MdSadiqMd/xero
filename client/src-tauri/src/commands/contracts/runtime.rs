...
pub fn runtime_agent_descriptor(agent_id: RuntimeAgentIdDto) -> RuntimeAgentDescriptorDto {
    match agent_id {
        ...
        RuntimeAgentIdDto::AgentCreate => RuntimeAgentDescriptorDto {
            ...
            description: "Interview the user and draft high-quality custom agent definitions without mutating repositories or saving agents yet.".into(),
            task_purpose: "Gather intent, clarify scope, propose least-privilege capabilities, and produce reviewable agent-definition drafts.".into(),
            scope: RuntimeAgentScopeDto::BuiltIn,
            lifecycle_state: RuntimeAgentLifecycleStateDto::Active,
