	...
	return (
		<div className="flex min-h-dvh bg-background text-foreground">
			...
			<main className="flex min-h-dvh min-w-0 flex-1 flex-col">
				<header className="sticky top-0 z-20 flex items-center justify-between gap-2 bg-background px-4 pb-3 pt-[max(env(safe-area-inset-top),0.75rem)] lg:hidden">
				...
				<div className="flex min-h-full w-full flex-1 items-center justify-center">
					<Empty className="border-0">
						...
						<EmptyContent>
							{visibleSessions.length > 0 ? (
								<ul className="flex w-[min(28rem,calc(100vw-2rem))] flex-col gap-1 rounded-lg border border-border bg-background p-1 lg:hidden">
								...
								<SessionDrawer
									...
									trigger={
										<Button
											...
											size="sm"
											variant="secondary"
											className="h-9 gap-2 px-4 text-[12px] font-medium lg:hidden"
										>
